...
const AdminDashBoard = () => {
    const {name, role, email} = isAuthenticated();
        ...
        return (
            <div className="card">
                ...
                <ul className="list-group">
                    ...
                    {/* TODO: Manage Categories will be assignment */}
                    <li className="list-group-item">
    ...
    return (
        <Base title='Welcom to the Admin Area' description='Manage all your products here' className='container bg-success p-4'>
            <div className="row">
